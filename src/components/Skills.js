...
const Skills = () => {
  const skills = [
    ...
    },
    {
      imageUrl: node,
      skillName: 'Node Js',
      skillOverview: 'Node.js is an open-source, server-side JavaScript runtime environment that allows developers to build scalable and high-performance network applications',
    },
    {
      imageUrl: mongo,
      skillName: 'Mongo DB',
      skillOverview: 'MongoDB is a popular NoSQL database management system that uses a flexible, document-oriented data model to store and manage data.',
    }
